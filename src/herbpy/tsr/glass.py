...
def glass_grasp(robot, glass, manip=None, yaw_range=None, **kw_args):
    ...
    '''
    return _glass_grasp(
        robot, glass, manip=manip, yaw_range=yaw_range, **kw_args)


@TSRFactory('herb', 'plastic_glass', 'push_grasp')
def glass_push_grasp(robot,
                     glass,
                     manip=None,
                     yaw_range=None,
                     push_distance=0.1,
