...
@ActionMethod
def MoveCupAndPour(robot, table, manip_pitcher, manip_pose, cup, pitcher):
    """
    ...
    manip_pitcher.PlanToEndEffectorOffset(direction=-1*manip_pose[:3,0], distance=0.1, position_tolerance=0.1, execute=True)
